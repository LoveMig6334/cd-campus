...
export function MenuTile({
  ...
  return (
    ...
    >
      ...
      <div className="bg-blue px-2.5 pt-[7px] pb-[9px] text-center font-display italic text-[17px] leading-none text-white">
        {labelEn}
        <small className="mt-0.5 block font-mono text-[8.5px] not-italic uppercase tracking-[0.18em] text-yellow">
          {labelTh}
        </small>
      </div>
    </Link>
