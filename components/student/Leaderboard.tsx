...
export function Leaderboard({ rows }: { rows: LeaderRow[] }) {
  return (
    <section className="border-line bg-paper rounded-2xl border-[1.5px] p-3.5">
      <h2 className="mb-2.5 font-mono text-[10px] tracking-[0.18em] uppercase">
        ...
        {rows.map((row, i) => (
          <div
            ...
            className={cn(
              ...
              i < rows.length - 1 && "border-mute-200 border-b border-dashed",
            )}
          >
            <div
              className={cn(
            ...
            <div className="flex items-center gap-2">
              <span
                aria-hidden
                className="border-ink inline-block h-3.5 w-3.5 rounded-full border-[1.5px]"
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <div className="border-ink bg-mute-100 h-1.5 w-[60px] overflow-hidden border">
                <span
